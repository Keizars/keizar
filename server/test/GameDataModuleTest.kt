...
import org.keizar.server.logic.GameDataModuleImpl
...
class GameDataModuleTest {
    ...
    fun `test remove data`() = runTest{
        ...
        gameDataModule.addGameData(gameData1)
